...
public class WriteXML_ParserEventHandler implements PDMLParserEventHandler<ASTNodeName, String> {
    ...
    public void onComment ( @NotNull TextToken comment, @NotNull ASTNodeName parentNode )
        ...
        XMLWriter.writeComment ( PDMLParserHelper.stripStartAndEndFromComment ( comment.getText() ) );
    }
