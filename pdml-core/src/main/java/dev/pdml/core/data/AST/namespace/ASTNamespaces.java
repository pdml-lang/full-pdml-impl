...
public class ASTNamespaces {
    ...
    public ASTNamespaces add ( @NotNull ASTNamespace namespace ) {
        ...
        return addOrReplace ( namespace );
    }

    public ASTNamespaces add ( @NotNull Namespace namespace ) {

        return add ( ASTNamespace.namespaceToASTNamespace ( namespace ) );
    }

    public ASTNamespaces addOrReplace ( @NotNull ASTNamespace namespace ) {

        map.put ( namespace.getPrefixText(), namespace );
        return this;
    }

    public ASTNamespaces remove ( @NotNull ASTNamespace namespace ) {
