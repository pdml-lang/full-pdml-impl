...
public class Logger_ParserEventHandler implements PDMLParserEventHandler<ASTNodeName, String> {
    ...
    */
    ...
    ASTNodeName onRootNodeStart ( @NotNull NodeStartEvent event ) throws Exception {
        ...
        if ( logRootNodeStart ) {
            writeEvent ( "Root start", name.getLocation(), name.qualifiedName () );
        }
        return name;
    }
    ...
    ASTNodeName onNodeStart ( @NotNull NodeStartEvent event, @NotNull ASTNodeName parentNode ) throws Exception {
        ...
        ASTNodeName name = event.getName();
        if ( logNodeStart ) {
            writeEvent ( "Node start", name.getLocation(), name.qualifiedName () );
        }
        return name;
    }
