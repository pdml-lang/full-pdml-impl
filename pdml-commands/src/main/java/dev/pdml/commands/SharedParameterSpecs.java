...
public class SharedParameterSpecs {
    ...
    public static @NotNull ParameterSpec<Path> positionalInputFileOrNull (
    ...
    public static @NotNull ParameterSpec<Path> positionalOutputFileOrNull (
        @NotNull String title,
        @NotNull String description,
        @Nullable String examples ) {
    ...
    public static @NotNull ParameterSpec<Path> outputFileOrNull (
        @NotNull String title,
        @NotNull String description,
        @Nullable String examples ) {
    ...
    public static final @NotNull ParameterSpec<SimpleLogger.LogLevel> VERBOSITY = new ParameterSpec.Builder<> (
    ...
    public static final @NotNull ParameterSpec<String> OPEN_FILE_OS_COMMAND_TEMPLATE = new ParameterSpec.Builder<> (
