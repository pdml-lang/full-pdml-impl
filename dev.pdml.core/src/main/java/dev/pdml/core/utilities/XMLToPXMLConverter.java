...
public class XMLToPXMLConverter {
    ...
    public static void XMLFileToPXMLFile ( @NotNull File XMLFile, @NotNull File pXMLFile ) throws Exception {
        ...
        final FileReader XMLFileReader = FileUtilities.getUTF8FileReader ( XMLFile );
        final FileWriter pXMLFileWriter = FileUtilities.getUTF8FileWriter ( pXMLFile );
    ...
    private static void XMLEventReaderToPXML (
        ...
        */
        ...
        PXMLWriter pXMLWriter_ = new DefaultPXMLWriter( pXMLWriter );
    ...
    private static void handleStartElement (
        @NotNull StartElement XMLEvent, @NotNull PXMLWriter pXMLWriter, boolean isEmptyElement ) throws IOException {
